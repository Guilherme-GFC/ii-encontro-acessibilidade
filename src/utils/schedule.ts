export default {
	event: "II Encontro sobre Acessibilidade em Unidades de Conservação Federais",
	days: [
		{
			date: "15/09/26",
			...
			activities: [
				...
				},
				{
					time: "10:30",
					title:
						"Palestra magna: O papel do Estado na Efetivação do Direito à Natureza e à Inclusão",
					details:
						"Secretaria Nacional dos Direitos da Pessoa com Deficiência - Secretário Substituto, Alex Alverga (participação online)",
				},
				{
					time: "11:30",
					title:
		...
		},
		{
			...
			activities: [
				...
				{
					time: "17:00",
					title: "Mesa de encerramento",
					details: "CGEUP/COEST/Chefe PN Iguaçu",
				},
			],
		},
	],
